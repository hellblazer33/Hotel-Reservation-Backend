    ...
    public class MSMQ
    {
        ...
        private void MessageQueue_ReceiveCompleted(object sender, ReceiveCompletedEventArgs e)
        {
            ...
            try
            {
                ...
                {
                    Port = 587,
                    Credentials = new NetworkCredential("hellblazer33522@gmail.com", "11041995"),
                    EnableSsl = true


                };
                mailMessage.From = new MailAddress("hellblazer33522@gmail.com");
                mailMessage.To.Add(new MailAddress("hellblazer33522@gmail.com"));
